	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			return array(
				...
				'preview_bg'       => $query->row['preview_bg'],
				'preview_left'     => $query->row['preview_left'],
				'preview_top'      => $query->row['preview_top'],
			);
		} else {
			return false;
		}
