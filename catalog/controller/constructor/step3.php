<?php
class ControllerConstructorStep3 extends Controller {
	public function index() {
		$data = $this->main();
		$this->response->setOutput($this->load->view( 'constructor/step3', $data));
	}
	...
	public function filter() {
		$data = $this->main();
		$this->response->setOutput( $data['filter'] );
	}
	...
	public function main() {
		...
		$data['products'] = $this->load->view( 'constructor/step3_product', $data );
		$data['filter'] = $this->load->view( 'constructor/step3_filter', $data );
