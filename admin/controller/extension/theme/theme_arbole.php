<?php
class ControllerExtensionThemeThemeArbole extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/theme/' . $this->my_name, 'user_token=' . $this->session->data['user_token'], true)
		);
		...
		$this->response->setOutput($this->load->view('extension/theme/theme_arbole', $data) );
	}
	...
	public function install() {
		...
		$this->model_extension_theme_arbole->add_tables();
	}

	public function uninstall() {
		$this->load->model( 'extension/theme/arbole' );

		$this->model_extension_theme_arbole->remove_tables();
	}
