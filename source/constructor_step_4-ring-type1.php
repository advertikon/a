...
<div class="container-inner">
  <div class="constructor-wrapper">
    ...
    <div class="step-wrapper">
      ...
      <div class="canvas canvas-ring" data-place="260, 180">
        <div class="scrollbar-outer">
          <div class="basement">
            <img src="<?php includeImg('ring-basement.png'); ?>">
    ...
    <div class="constructor-edit-sidebar">
      ...
      <div class="edit-steps">
        ...
        <a href="constructor_step_3-ring-type1.php" class="edit-step hidden">
          <span><img src="<?php includeImg('edit-available.png'); ?>"></span>
          My jewellery material
        </a>
        <a href="constructor_step_4-ring-type1.php" class="edit-step active">
