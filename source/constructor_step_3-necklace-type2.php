  ...
  <div class="constructor-wrapper">
    ...
    <div class="step-wrapper">
      ...
      <div class="scrollbar-outer">
        ...
        <div class="btns">
          <button class="back" onclick="window.location='constructor_step_2_edit-necklace.php'"><span></span>back</button>
          <button disabled onclick="window.location='constructor_step_4-necklace-type2.php'"><span></span>next step</button>
        </div>
      </div>
    </div>
    <div class="constructor-edit-sidebar">
      ...
      <div class="edit-steps">
        ...
        <a href="constructor_step_2_edit-necklace.php" class="edit-step">
          <span><img src="<?php includeImg('edit-available.png'); ?>"></span>
          My jewellery model
        </a>
