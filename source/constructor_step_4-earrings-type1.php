...
<div class="container-inner">
  <div class="constructor-wrapper">
    ...
    <div class="step-wrapper">
      ...
      <div class="canvas canvas-earring" data-place="285, 260">
        <div class="scrollbar-outer">
          <div class="basement">
            <img src="<?php includeImg('earring1-basement.png'); ?>">
            <canvas id="canvas" class="part-place"></canvas>
          </div>
          <div class="final-img model-earring model-earring-type1"><img src=""></div>
        </div>
      </div>
      ...
      <div class="constructor-total-wrapper">
        <div class="error-text"><div class="close"><img src="<?php includeImg('close-small.png'); ?>"></div><p>You have exceeded the limit of the weight of this product.</p></div>
    ...
    <div class="constructor-edit-sidebar">
      ...
      <div class="edit-steps">
        ...
        <a href="constructor_step_2_edit-earrings.php" class="edit-step hidden">
          <span><img src="<?php includeImg('edit-available.png'); ?>"></span>
          My jewellery model
        </a>
        <a href="constructor_step_3-earrings-type1.php" class="edit-step hidden">
          <span><img src="<?php includeImg('edit-available.png'); ?>"></span>
          My jewellery material
        </a>
        <a href="constructor_step_4-earrings-type1.php" class="edit-step active">
        ...
        <a href="constructor_step_5.php" class="edit-step hidden">
          <span>5</span>
          My order
        </a>
        <div class="product-info">
          <div class="product-name"><label>Description:</label><span>“Silver” Ring</span></div>
          <div class="product-options">
            ...
            <div class="error-text">You have exceeded the limit of the length of this product.</div>
            <div class="option">
