  ...
  <div class="constructor-wrapper">
    ...
    <div class="step-wrapper">
      ...
      <div class="scrollbar-outer">
        <div class="product-list">
          <?php for ($i=0; $i < 1; $i++):?>
            <div class="product-item">
              <input type="radio" name="type" id="product-<?= $i; ?>"/>
              <label for="product-<?= $i; ?>">
                <div class="img">
        ...
        <div class="btns">
          <button class="back" onclick="window.location='constructor_step_2_edit-ring.php'"><span></span>back</button>
          <button disabled onclick="window.location='constructor_step_4-ring-type2.php'"><span></span>next step</button>
        </div>
      </div>
    </div>
    <div class="constructor-edit-sidebar">
      ...
      <div class="edit-steps">
        ...
        <a href="constructor_step_2_edit-ring.php" class="edit-step">
          <span><img src="<?php includeImg('edit-available.png'); ?>"></span>
          My jewellery model
        </a>
    ...
    <div class="popup-inner">
      <div class="popup-body">
        ...
        <div class="zoom-wrapper">
          <div class="product-name">Gold Plated Regular Ring</div>
