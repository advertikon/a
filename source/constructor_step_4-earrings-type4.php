...
<div class="container-inner">
  <div class="constructor-wrapper">
    ...
    <div class="step-wrapper">
      ...
      <div class="canvas canvas-earring-long" data-place="287, 430">
        <div class="scrollbar-outer">
          <div class="basement">
            <img src="<?php includeImg('earring4-basement.png'); ?>">
            <canvas id="canvas" class="part-place"></canvas>
          </div>
          <div class="final-img model-earring model-earring-type4"><img src=""></div>
        </div>
      </div>
    ...
    <div class="constructor-edit-sidebar">
      ...
      <div class="edit-steps">
        ...
        <a href="constructor_step_3-earrings-type4.php" class="edit-step hidden">
          <span><img src="<?php includeImg('edit-available.png'); ?>"></span>
          My jewellery material
        </a>
        <a href="constructor_step_4-earrings-type4.php" class="edit-step active">
