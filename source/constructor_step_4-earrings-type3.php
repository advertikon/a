...
<div class="container-inner">
  <div class="constructor-wrapper">
    ...
    <div class="step-wrapper">
      ...
      <div class="canvas canvas-earring" data-place="287, 260">
        <div class="scrollbar-outer">
          <div class="basement">
            <img src="<?php includeImg('earring3-basement.png'); ?>">
            <canvas id="canvas" class="part-place"></canvas>
          </div>
          <div class="final-img model-earring model-earring-type3"><img src=""></div>
        </div>
      </div>
    ...
    <div class="constructor-edit-sidebar">
      ...
      <div class="edit-steps">
        ...
        <a href="constructor_step_3-earrings-type3.php" class="edit-step hidden">
          <span><img src="<?php includeImg('edit-available.png'); ?>"></span>
          My jewellery material
        </a>
        <a href="constructor_step_4-earrings-type3.php" class="edit-step active">
    ...
    <div class="popup-inner">
      <div class="popup-body">
        <div class="zoom-popup">
          ...
          <div class="range"><input type="range"></label></div>
        </div>
      </div>
    </div>
  </div>
