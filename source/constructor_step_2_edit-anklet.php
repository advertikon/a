  ...
  <div class="constructor-wrapper">
    ...
    <div class="step-wrapper">
      ...
      <div class="jewellery-type">
        <div class="type">
          <input type="radio" name="type" id="type1" data-type="anklet"/>
          <label for="type1">
            <div class="img"><img src="<?php includeImg('type-anklet-1.svg'); ?>"></div>
            <p>Chain</p>
          </label>
        </div>
        <div class="type">
          <input type="radio" name="type" id="type2" data-type="anklet"/>
          <label for="type2">
        ...
        <div class="type">
          <input type="radio" name="type" id="type3" data-type="anklet"/>
          <label for="type3">
            <div class="img"><img src="<?php includeImg('type-anklet-3.svg'); ?>"></div>
            <p>String</p>
          </label>
        </div>
      </div>
