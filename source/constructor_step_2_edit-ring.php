  ...
  <div class="constructor-wrapper">
    ...
    <div class="step-wrapper">
      ...
      <div class="jewellery-type">
        <div class="type">
          <input type="radio" name="type" id="type1" data-type="ring"/>
          <label for="type1">
        ...
        <div class="type">
          <input type="radio" name="type" id="type2" data-type="ring"/>
          <label for="type2">
            <div class="img"><img src="<?php includeImg('type-ring-2.svg'); ?>"></div>
            <p>Structure</p>
          </label>
        </div>
        <div class="type">
          <input type="radio" name="type" id="type3" data-type="ring"/>
          <label for="type3">
            <div class="img"><img src="<?php includeImg('type-ring-3.svg'); ?>"></div>
            <p>Wedding</p>
          </label>
        </div>
      </div>
