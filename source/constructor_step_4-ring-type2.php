...
<div class="container-inner">
  <div class="constructor-wrapper">
    ...
    <div class="step-wrapper">
      ...
      <div class="canvas canvas-ring" data-place="260, 170">
        <div class="scrollbar-outer">
          <div class="basement">
            <img src="<?php includeImg('ring2-basement.png'); ?>">
            <canvas id="canvas" class="part-place"></canvas>
          </div>
          <div class="final-img model-ring"><img src=""></div>
        </div>
      </div>
    ...
    <div class="constructor-edit-sidebar">
      ...
      <div class="edit-steps">
        ...
        <a href="constructor_step_2_edit-ring.php" class="edit-step hidden">
          <span><img src="<?php includeImg('edit-available.png'); ?>"></span>
          My jewellery model
        </a>
        <a href="constructor_step_3-ring-type2.php" class="edit-step hidden">
          <span><img src="<?php includeImg('edit-available.png'); ?>"></span>
          My jewellery material
        </a>
        <a href="constructor_step_4-ring-type2.php" class="edit-step active">
