  ...
  <div class="constructor-wrapper">
    ...
    <div class="step-wrapper">
      ...
      <div class="scrollbar-outer">
        ...
        <div class="btns">
          <button class="back" onclick="window.location='constructor_step_2_edit-earrings.php'"><span></span>back</button>
          <button disabled onclick="window.location='constructor_step_4-earrings-type1.php'"><span></span>next step</button>
        </div>
      </div>
    </div>
    <div class="constructor-edit-sidebar">
      ...
      <div class="edit-steps">
        ...
        <a href="constructor_step_2_edit-earrings.php" class="edit-step">
          <span><img src="<?php includeImg('edit-available.png'); ?>"></span>
          My jewellery model
        </a>
          ...
          <div class="swiper-container">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="img">
                  <img src="<?php includeImg('earring-basement.png'); ?>">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="img">
